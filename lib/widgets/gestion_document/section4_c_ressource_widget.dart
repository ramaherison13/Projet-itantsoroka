...
class _Section4WidgetState extends State<Section4Widget> {
  ...
  void _navigateToDocumentPage() {
    // Gérez la navigation vers la page de consultation avec le filtre de type "Outils numériques"
    debugPrint("Navigation vers la liste avec le filtre Outils numériques");
  }
  ...
  Widget build(BuildContext context) {
    ...
    // Filtrer les documents de type "Outils numériques" et limiter à 3
    final outilsDocuments = _documents
        .where((doc) => doc['type']?.toString().toLowerCase() == 'outils numériques'.toLowerCase())
        .take(3)
        .toList();
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
              ...
              children: [
                Container(
                  ...
                  child: Image.asset(
                    ...
                    width: 40,
                    height: 40,
                    errorBuilder: (context, error, stackTrace) => const Icon(Icons.devices, color: Colors.green, size: 28),
                  ),
                ),
          ...
          if (_loading)
          ...
          else if (outilsDocuments.isEmpty)
            Center(
              child: Padding(
            ...
            GridView.builder(
              ...
              itemCount: outilsDocuments.length,
              itemBuilder: (context, index) {
                final doc = outilsDocuments[index];
